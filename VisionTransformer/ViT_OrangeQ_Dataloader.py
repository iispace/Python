...
class ImgPatcherNDataLoader:
    def __init__(self, dataname='imagenet', patch_size=16, img_size=256, batch_size=64):
    ...
    def patchdata(self):
        ...
        if self.dataname == 'OrangeQuality':
            IMAGE_ROOT = rf"D:\HYCU_Lab\0_JJ\2_HYCU_MasterDegree\Data\ConvertedImage\OrangeQuality"
            trainset = OrangeQualityDataset(IMAGE_ROOT, train=True, transform=train_transform)
            testset  = OrangeQualityDataset(IMAGE_ROOT, train=False, transform=test_transform)
